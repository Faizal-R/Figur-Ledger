...
container.bind<ILoanApplicationRepository>(DI_TOKENS.REPOSITORIES.LOAN_APPLICATION_REPOSITORY).to(LoanApplicationRepository);
container.bind<ILoanProductRepository>(DI_TOKENS.REPOSITORIES.LOAN_PRODUCT_REPOSITORY).to(LoanProductRepository);
container.bind<ICreditProfileRepository>(DI_TOKENS.REPOSITORIES.CREDIT_PROFILE_REPOSITORY).to(CreditProfileRepository);
container.bind<IRepaymentScheduleRepository>(DI_TOKENS.REPOSITORIES.REPAYMENT_SCHEDULE_REPOSITORY).to(RepaymentScheduleRepository);
